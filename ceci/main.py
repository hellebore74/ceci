...
parser.add_argument(
    "--yamlId",
    type=str,
    help="number of the yaml config document - if a multiple document yaml file is used (yaml concatenation)",
)
...
def main():  # pragma: no cover
    ...
    pipe_config = Pipeline.build_config(
        args.pipeline_config, args.extra_config, args.dry_run, args.flow_chart, args.yamlId,
    )
